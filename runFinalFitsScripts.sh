...
if [ $DOSTAGE1 == 1 ]; then
  ...
  #./makeStage1Datacard.py -i $FILE  -o Datacard_13TeV_${EXT}.txt -p $PROCS -c $CATS --photonCatScales $SCALES --photonCatSmears $SMEARS --isMultiPdf --mass 125 --intLumi $INTLUMI --uepsfilename $UEPS --newGghScheme --doSTXS --doUEPS
else
...
#echo "text2workspace.py /vols/build/cms/es811/FreshStart/STXSstage1/Pass0/CMSSW_8_1_0/src/flashggFinalFit/Plots/FinalResults/CMS-HGG_mva_13TeV_datacard.txt -o /vols/build/cms/es811/FreshStart/STXSstage1/Pass0/CMSSW_8_1_0/src/flashggFinalFit/Plots/FinalResults/CMS-HGG_mva_13TeV_datacard_PerProcessMu.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel  --PO map=.*/qqH_*_hgg:r_qqH[1,0,5] --PO map=.*/ggH_hgg_0J*:r_ggH_0J[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_0_60:r_ggH_1J_low[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_60_120:r_ggH_1J_med[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_120_200:r_ggH_1J_high[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_0_60:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_60_120:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_120_200:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_VBFTOPO*:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_GT200:r_ggH_BSM[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_GT200:r_ggH_BSM[1,0,5] --PO map=.*/ttH_hgg*:r_ttH[1,0,5] --PO map=.*/WH_lep_hgg*:r_QQ2HLNU[1,0,5] --PO map=.*/ZH_lep_hgg*:r_QQ2HLL[1,0,5] --PO map=.*/WH_had_hgg*:r_VH2HQQ[1,0,5] --PO map=.*/ZH_had_hgg*:r_VH2HQQ[1,0,5] --PO higgsMassRange=122,128  -L $CMSSW_BASE/lib/$SCRAM_ARCH/libHiggsAnalysisGBRLikelihood.so"
#text2workspace.py /vols/build/cms/es811/FreshStart/STXSstage1/Pass0/CMSSW_8_1_0/src/flashggFinalFit/Plots/FinalResults/CMS-HGG_mva_13TeV_datacard.txt -o /vols/build/cms/es811/FreshStart/STXSstage1/Pass0/CMSSW_8_1_0/src/flashggFinalFit/Plots/FinalResults/CMS-HGG_mva_13TeV_datacard_PerProcessMu.root -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel  --PO map=.*/qqH_*_hgg:r_qqH[1,0,5] --PO map=.*/ggH_hgg_0J*:r_ggH_0J[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_0_60:r_ggH_1J_low[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_60_120:r_ggH_1J_med[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_120_200:r_ggH_1J_high[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_0_60:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_60_120:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_120_200:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_VBFTOPO*:r_ggH_GE2J[1,0,5] --PO map=.*/ggH_hgg_1J_PTH_GT200:r_ggH_BSM[1,0,5] --PO map=.*/ggH_hgg_GE2J_PTH_GT200:r_ggH_BSM[1,0,5] --PO map=.*/ttH_hgg*:r_ttH[1,0,5] --PO map=.*/WH_lep_hgg*:r_QQ2HLNU[1,0,5] --PO map=.*/ZH_lep_hgg*:r_QQ2HLL[1,0,5] --PO map=.*/WH_had_hgg*:r_VH2HQQ[1,0,5] --PO map=.*/ZH_had_hgg*:r_VH2HQQ[1,0,5] --PO higgsMassRange=122,128  -L $CMSSW_BASE/lib/$SCRAM_ARCH/libHiggsAnalysisGBRLikelihood.so
##
#echo "combine  CMS-HGG_mva_13TeV_datacard_PerProcessMu.root -M MultiDimFit -m 125 -n _bonlyForLoading_$EXT -t -1  --setParameters r_ggH_0J=0,r_ggH_1J_low=0,r_ggH_1J_med=0,r_ggH_1J_high=0,r_ggH_BSM=0,r_ggH_GE2J=0,r_qqH=0,r_ttH=0,r_QQ2HLNU=0,r_QQ2HLL=0,r_VH2HQQ=0 --saveWorkspace"
#combine  CMS-HGG_mva_13TeV_datacard_PerProcessMu.root -M MultiDimFit -m 125 -n _bonlyForLoading_$EXT -t -1  --setParameters r_ggH_0J=0,r_ggH_1J_low=0,r_ggH_1J_med=0,r_ggH_1J_high=0,r_ggH_BSM=0,r_ggH_GE2J=0,r_qqH=0,r_ttH=0,r_QQ2HLNU=0,r_QQ2HLL=0,r_VH2HQQ=0 --saveWorkspace
##
#echo "mv higgsCombine_bonlyForLoading_$EXT.MultiDimFit.mH125.root STXSExpPerProcessMuFinerProfileMH_BonlyForLoading_$EXT.root"
