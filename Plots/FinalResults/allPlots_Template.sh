...
./makeCombinePlots.py -f combineJobs13TeV_$EXT/ExpMuScanStat/ExpMuScanStat.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_VH/r_VH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_ttH/r_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_qqH/r_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityStatProfileMH/r_ggH/r_ggH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityProfileMHstat --do1sig  -l 0.55,0.65,0.85,0.9 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV), STAT ONLY" --mhval "Profiled"  -b
./makeCombinePlots.py -f combineJobs13TeV_$EXT/ExpMuScanTheo/ExpMuScanTheo.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityTheoProfileMH/r_VH/r_VH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityTheoProfileMH/r_ttH/r_ttH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityTheoProfileMH/r_qqH/r_qqH.root,combineJobs13TeV_$EXT/PerProcessChannelCompatibilityTheoProfileMH/r_ggH/r_ggH.root --perprocchcomp -x -2,9 -o PerProcChannelCompatibilityProfileMHtheo --do1sig  -l 0.55,0.65,0.85,0.9 --text="  ${INTLUMI} fb^{-1} (13#scale[0.5]{ }TeV), THEO ONLY" --mhval "Profiled"  -b
...
./makeCombinePlots.py -f combineJobs13TeV_$EXT/RVRFScanFixMH/RVRFScanFixMH.root --rvrf -t "$INTLUMI fb^{-1} (13#scale[0.5]{ }TeV)" -o RVRFScanFixMH --xbinning 50,-1.,3. --ybinning 50,-1.,3. --MHtext 0.17:0.17:"m_{H}=125.09 GeV" --legend 0.68,0.63,0.82,0.87 -b 
